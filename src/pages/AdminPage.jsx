...
function AdminLogin({ onSuccess }) {
  ...
  function submit(event) {
    ...
    if (signInAdmin(accessCode)) onSuccess()
    else setError('Access denied. Configure your private admin code first.')
  }
